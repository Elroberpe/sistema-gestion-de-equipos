...
public class PanelPrestamos extends JPanel {
    ...
    public PanelPrestamos() {
    	...
    	gbcLblBuscarSolicitante.gridx = 0;
    	gbcLblBuscarSolicitante.gridy = 0;
    	...
    	gbcLineaSolicitante.gridx = 0;
    	gbcLineaSolicitante.gridy = 1;
    	...
    	JTextField txtDniSolicitante = new JTextField("Ingrese DNI");
    	...
    	gbcTxtDni.gridx = 0;
    	gbcTxtDni.gridy = 3;
    	gbcTxtDni.gridwidth = 2;
    	gbcTxtDni.weightx = 1;
    	gbcTxtDni.fill = GridBagConstraints.HORIZONTAL;
    	gbcTxtDni.insets = new Insets(5, 5, 5, 5);
    	panelBuscarSolicitante.add(txtDniSolicitante, gbcTxtDni);

    	JButton btnBuscarSolicitante = new JButton("Buscar");
    	...
    	gbcBtnBuscarSolicitante.gridx = 2;
    	gbcBtnBuscarSolicitante.gridy = 3;
    	...
    	gbcLblNombres.gridx = 0;
    	gbcLblNombres.gridy = 4;
    	gbcLblNombres.gridwidth = 1;
    	...
    	gbcLblApellidos.gridx = 1;
    	gbcLblApellidos.gridy = 4;
    	gbcLblApellidos.gridwidth = 2;
    	...
    	gbcTxtNombres.gridx = 0;
    	gbcTxtNombres.gridy = 5;
    	gbcTxtNombres.gridwidth = 1;
    	gbcTxtNombres.weightx = 1;
    	gbcTxtNombres.fill = GridBagConstraints.HORIZONTAL;
    	...
    	gbcTxtApellidos.gridx = 1;
    	gbcTxtApellidos.gridy = 5;
    	gbcTxtApellidos.gridwidth = 2;
    	gbcTxtApellidos.weightx = 1;
    	gbcTxtApellidos.fill = GridBagConstraints.HORIZONTAL;
    	...
    	gbcTxtArea.weightx = 1;
    	gbcTxtArea.fill = GridBagConstraints.HORIZONTAL;
    	gbcTxtArea.insets = new Insets(5, 5, 5, 5);
    	panelBuscarSolicitante.add(txtArea, gbcTxtArea);
    	
    	//contenido buscar equipo 
    	...
    	gbcLblBuscarEquipo.gridx = 0;
    	gbcLblBuscarEquipo.gridy = 0;
    	gbcLblBuscarEquipo.gridwidth = 3;
    	...
    	gbcLineaEquipo.gridx = 0;
    	gbcLineaEquipo.gridy = 1;
    	gbcLineaEquipo.gridwidth = 3;
    	...
    	gbcLblCodigoEquipo.gridx = 0;
    	gbcLblCodigoEquipo.gridy = 2;
    	gbcLblCodigoEquipo.gridwidth = 3;
    	...
    	JTextField txtCodigoEquipo = new JTextField();
    	...
    	gbcTxtCodigoEquipo.gridx = 0;
    	gbcTxtCodigoEquipo.gridy = 3;
    	gbcTxtCodigoEquipo.gridwidth = 2;
    	...
    	gbcBtnBuscarEquipo.gridx = 2;
    	gbcBtnBuscarEquipo.gridy = 3;
    	gbcBtnBuscarEquipo.gridwidth = 1;
    	...
    	gbcLblDescripcion.gridy = 4;
    	gbcLblDescripcion.gridwidth = 3;
    	...
    	gbcTxtDescripcion.gridx = 0;
    	gbcTxtDescripcion.gridy = 5;
    	gbcTxtDescripcion.gridwidth = 3;
    	gbcTxtDescripcion.weightx = 1;
    	gbcTxtDescripcion.fill = GridBagConstraints.HORIZONTAL;
    	...
    	gbcLblMarcaModelo.gridx = 0;
    	gbcLblMarcaModelo.gridy = 6;
    	gbcLblMarcaModelo.gridwidth = 1;
    	...
    	gbcLblEstadoActual.gridx = 1;
    	gbcLblEstadoActual.gridy = 6;
    	gbcLblEstadoActual.gridwidth = 2;
    	...
    	gbcTxtMarcaModelo.gridx = 0;
    	gbcTxtMarcaModelo.gridy = 7;
    	gbcTxtMarcaModelo.gridwidth = 1;
    	gbcTxtMarcaModelo.weightx = 1;
    	gbcTxtMarcaModelo.fill = GridBagConstraints.HORIZONTAL;
    	...
    	gbcTxtEstadoActual.gridx = 1;
    	gbcTxtEstadoActual.gridy = 7;
    	gbcTxtEstadoActual.gridwidth = 2;
    	gbcTxtEstadoActual.weightx = 1;
    	gbcTxtEstadoActual.fill = GridBagConstraints.HORIZONTAL;
    	...
    	gbcLblDetallePrestamo.gridx = 0;
    	gbcLblDetallePrestamo.gridy = 0;
    	gbcLblDetallePrestamo.gridwidth = 6;
    	...
    	gbcLineaDetalle.gridx = 0;
    	gbcLineaDetalle.gridy = 1;
    	gbcLineaDetalle.gridwidth = 6;
    	...
    	gbcLblFechaPrestamo.gridx = 0;
    	gbcLblFechaPrestamo.gridy = 2;
    	gbcLblFechaPrestamo.gridwidth = 1;
    	...
    	gbcLblFechaDevolucion.gridx = 1;
    	gbcLblFechaDevolucion.gridy = 2;
    	gbcLblFechaDevolucion.gridwidth = 1;
    	...
    	gbcLblObservaciones.gridx = 2;
    	gbcLblObservaciones.gridy = 2;
    	gbcLblObservaciones.gridwidth = 2;
    	...
    	JTextField txtFechaPrestamo = new JTextField("25/10/2023");
    	...
    	gbcTxtFechaPrestamo.gridx = 0;
    	gbcTxtFechaPrestamo.gridy = 3;
    	gbcTxtFechaPrestamo.gridwidth = 1;
    	gbcTxtFechaPrestamo.weightx = 1;
    	gbcTxtFechaPrestamo.fill = GridBagConstraints.HORIZONTAL;
    	gbcTxtFechaPrestamo.insets = new Insets(5, 5, 5, 5);
    	panelDetalle.add(txtFechaPrestamo, gbcTxtFechaPrestamo);


    	JTextField txtFechaDevolucion = new JTextField("dd/mm/aaaa");
    	...
    	gbcTxtFechaDevolucion.gridx = 1;
    	gbcTxtFechaDevolucion.gridy = 3;
    	gbcTxtFechaDevolucion.gridwidth = 1;
    	gbcTxtFechaDevolucion.weightx = 1;
    	gbcTxtFechaDevolucion.fill = GridBagConstraints.HORIZONTAL;
    	...
    	gbcTxtObservaciones.gridx = 2;
    	gbcTxtObservaciones.gridy = 3;
    	gbcTxtObservaciones.gridwidth = 2;
    	gbcTxtObservaciones.weightx = 2;
    	gbcTxtObservaciones.fill = GridBagConstraints.HORIZONTAL;
    	...
    	gbcBtnRegistrar.gridx = 5;
    	gbcBtnRegistrar.gridy = 3;
    	gbcBtnRegistrar.gridwidth = 1;
    	...
    	DefaultTableModel modelo = new DefaultTableModel(
    	        new Object[][] {
    	                { "PR-1024", "Ana Martínez - Marketing", "PROY-005 (Proyector Epson)", "25/10/2023", "26/10/2023", "Activo" },
    	                { "PR-1025", "Luis Fernández - Ventas", "TAB-012 (Tablet Samsung)", "25/10/2023", "30/10/2023", "Activo" },
    	                { "PR-1026", "Carlos Ruiz - Contabilidad", "LAP-042 (Lenovo ThinkPad)", "24/10/2023", "24/10/2023", "Vencido" },
    	                { "PR-1027", "María Gómez - Dirección", "LAP-010 (Laptop HP)", "23/10/2023", "28/10/2023", "Activo" }
    	        },
    	        new String[] {
    	                "ID", "Solicitante", "Equipo", "F. Préstamo", "F. Prev. Dev.", "Estado"
    	        }
    	) {
    	    private static final long serialVersionUID = 1L;
